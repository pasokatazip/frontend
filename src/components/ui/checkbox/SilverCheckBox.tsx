...
type SilverCheckBoxProps = NativeInputProps & {
  "aria-label": string;
  checked?: boolean;
  className?: string;
...
export function SilverCheckBox({
  checked,
  className,
  ...
  return (
    <label className="inline-block">
      ...
      <span
        ...
        style={{
          background: isChecked ? gradients.silver : gradients.silver,
          boxShadow: isChecked ? shadows.silver : shadows.lightblue,
          ...style,
        }}
      >
        {isChecked ? (
