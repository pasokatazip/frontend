...
ARG NEXT_PUBLIC_PETYOYO_IMAGE_URL
ARG NEXT_PUBLIC_PETYOYO_IMAGE_VERSION
ENV NEXT_PUBLIC_VAPID_PUBLIC_KEY=${NEXT_PUBLIC_VAPID_PUBLIC_KEY}
ENV NEXT_PUBLIC_PETYOYO_IMAGE_URL=${NEXT_PUBLIC_PETYOYO_IMAGE_URL}
ENV NEXT_PUBLIC_PETYOYO_IMAGE_VERSION=${NEXT_PUBLIC_PETYOYO_IMAGE_VERSION}
